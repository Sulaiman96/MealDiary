                        ...
                        <div className="flex items-center xl:p-10">
                            <form className="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl" onSubmit={handleSubmit(handleLogin)}>
                                ...
                                <div className="flex flex-row justify-between mb-8">
                                    ...
                                    <Link to={'/register'} className="mr-4 text-sm font-medium text-purple-blue-500">Forget password?</Link>
                                </div>
                                <button className="w-full px-4 py-4 mb-3 text-sm font-bold leading-none text-white transition duration-300 md:w-96 rounded-2xl hover:bg-purple-blue-600 focus:ring-4 focus:ring-purple-blue-100 bg-purple-blue-500">Sign In</button>
                                <p className="text-sm leading-relaxed text-grey-900">Not registered yet? <Link to={'/register'} className="font-bold text-grey-700">Sign Up</Link></p>
                            </form>
                        </div>
                    </div>
                </div>
